...
public class FilterFragment extends Fragment {
    ...
    private final PageViewModel.EventHandler mEventHandler = new PageViewModel.EventHandler() {
        ...
        public void onPrepareFilter() {
            ...
            //展示type
            if (mModel.needDemonstration()) {
                mModel.requestDemonstrate(false);
                ...
                try {
                    ...
                    Disposable disposable = Flowable.intervalRange(0, mBinding.spType.getCount(), 200, 61, TimeUnit.MILLISECONDS)
                            .observeOn(AndroidSchedulers.mainThread())
                            .subscribe(aLong -> {
                                View view = Objects.requireNonNull(Objects.requireNonNull(spinnerPopup).getListView()).getChildAt(aLong.intValue());
