...
public class TemplatePanel extends ConstraintLayout {
     ...
     */
    private final OnLayoutChangeListener mDecorViewLayoutChangeListener = new OnLayoutChangeListener() {
        @Override
    ...
    private void init() {
        ...
        Utils.getHostActivity(getContext()).getWindow().getDecorView().addOnLayoutChangeListener(mDecorViewLayoutChangeListener);
        getViewTreeObserver().addOnPreDrawListener(new ViewTreeObserver.OnPreDrawListener() {
            @Override
            public boolean onPreDraw() {
                mLaid = true;
                EditText editor = findViewById(R.id.et_editor);
                editor.setMinHeight(mScrollView.getHeight() - mHandler.getHeight());
    ...
    protected void onDetachedFromWindow() {
        ...
        Utils.getHostActivity(getContext()).getWindow().getDecorView().removeOnLayoutChangeListener(mDecorViewLayoutChangeListener);
    }
