...
import xjunz.tool.wechat.ui.message.fragment.AdvancedEditorFragment;
import xjunz.tool.wechat.ui.message.fragment.SimpleEditorFragment;
...
public class EditorActivity extends RecycleSensitiveActivity {
    ...
    public void confirmEdition(View view) {
        ...
        intent.putExtra(EXTRA_MESSAGE_ORIGIN, mEditorPages[mBinding.vpEditor.getCurrentItem()].getEditedMessage());
