...
public class PageViewModel extends ObservableViewModel {
    ...
    private boolean mNeedDemonstrationAllContactTypes;
    ...
    public void requestDemonstrateAllContactTypes(boolean needDemonstration) {
        mNeedDemonstrationAllContactTypes = needDemonstration;
    }

    public boolean needDemonstrationAllContactTypes() {
        return mNeedDemonstrationAllContactTypes;
    }
