...
import xjunz.tool.werecord.databinding.FragmentLvbufferEditorBinding;
import xjunz.tool.werecord.databinding.ItemLvbufferEditorBinding;
...
import static xjunz.tool.werecord.impl.model.message.util.LvBufferUtils.TYPE_BUFFER;
import static xjunz.tool.werecord.impl.model.message.util.LvBufferUtils.TYPE_INTEGER;
import static xjunz.tool.werecord.impl.model.message.util.LvBufferUtils.TYPE_LONG;
import static xjunz.tool.werecord.impl.model.message.util.LvBufferUtils.TYPE_STRING;
...
public class LvBufferEditorDialog extends ConfirmationDialog<Object[]> {
    ...
    public boolean isChanged(Object[] newValue) {
        ...
        return !Utils.arrayDeepEquals(mDef, newValue);
    }
    ...
    private class LvBufferViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        public void onClick(View v) {
            ...
            }).setDefault(getPreview(data)).setPredicateCallback(result -> {
                switch (type) {
                    case TYPE_STRING:
