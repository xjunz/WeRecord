 ...
 * 继承此类并在{@link RecycleAwareActivity#onCreateNormally(Bundle)}里执行正常的{@link android.app.Activity#onCreate(Bundle)}逻辑。
 */
public abstract class RecycleAwareActivity extends BaseActivity {
    /**
    ...
    private static final String TAG_RECYCLED = "RecycleAwareActivity.tag.recycled";
