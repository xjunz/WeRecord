...
public class GenericButtonMorph extends Transition {
     ...
     * @see R.styleable#Morph_opticalButtonColor
     */
    @ColorLong
    ...
    public GenericButtonMorph(Context context, AttributeSet attrs) {
        ...
        mOpticalButtonColor = ta.getColor(R.styleable.Morph_opticalButtonColor, Color.TRANSPARENT);
        ta.recycle();
    }
    ...
    public Animator createAnimator(ViewGroup sceneRoot, TransitionValues
        ...
        //从大视图过渡为小视图之前，Activity Transition框架会将当前较大视图layout为较小视图
        ...
        Drawable overlayButton = new BitmapDrawable(target.getContext().getResources(), bitmap);
